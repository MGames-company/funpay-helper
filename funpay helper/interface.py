...
class MainWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.auto_send_guard.setIcon(QIcon('D:/programs/development/rofls/.venv/funpay helper/data/icons/Guard'))
        ...
        self.Notifications.setIcon(QIcon('D:/programs/development/rofls/.venv/funpay helper/data/icons/Notification'))
        ...
        self.CommandsWidget.setMinimumSize(750, 300)
        ...
        self.ChangeWidget1 = QPushButton()
        self.ChangeWidget1.clicked.connect(self.showWidget1)
        self.ChangeWidget1.setIcon(QIcon('D:/programs/development/rofls/.venv/funpay helper/data/icons/imageCommands'))
        self.ChangeWidget1.setFixedSize(30,30)
        self.ChangeWidget1.setIconSize(QSize(30, 30))
        self.ChangeWidget2 = QPushButton()
        self.ChangeWidget2.setFixedSize(30, 30)
        self.ChangeWidget2.setIcon(QIcon('D:/programs/development/rofls/.venv/funpay helper/data/icons/SteamImage'))
        ...
        self.TableLots.setRowCount(10)
        self.TableLots.setMinimumSize(720, 250)
        ...
        """)
        self.TableLots.setHorizontalHeaderLabels(["Выданные логин/пароль", "Почта", "Пароль"])
        ...
        self.ChatGrid.addWidget(self.changedWidgets, 3, 0,0,0)
        ...
        SettingsGrid.addWidget(NotificationWidget,0,0)
    ...
    def send_guard(self, checked):
        if self.Isloggin == True:
            if checked:
                ...
                self.auto_send_guard.setIcon(QIcon('D:/programs/development/rofls/.venv/funpay helper/data/icons/Guard2'))
    ...
    def enable_notifications(self,checked):
        if checked:
            self.Notifications.setIcon(QIcon('D:/programs/development/rofls/.venv/funpay helper/data/icons/Notification2'))
